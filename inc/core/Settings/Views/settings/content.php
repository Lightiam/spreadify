        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <input type="text" name="website_favicon" id="website_favicon" class="form-control form-control-solid" placeholder="<?php _e("Select file")?>" value="<?php _ec( get_option("website_favicon", base_url("assets/img/favicon.png")) )?>">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <input type="text" name="website_logo_mark" id="website_logo_mark" class="form-control form-control-solid" placeholder="<?php _e("Select file")?>" value="<?php _ec( get_option("website_logo_mark", base_url("assets/img/logo.png")) )?>">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <input type="text" name="website_logo_color" id="website_logo_color" class="form-control form-control-solid" placeholder="<?php _e("Select file")?>" value="<?php _ec( get_option("website_logo_color", base_url("assets/img/logo.png")) )?>">
