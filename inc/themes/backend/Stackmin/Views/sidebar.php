    ...
    <div class="sidebar d-flex flex-column align-items-lg-center flex-row-auto h-100">
        <div class="sidebar-logo d-flex flex-column align-items-center flex-column-auto py-3">
            <a href="<?php _ec( base_url("dashboard") )?>">
                <img alt="Logo" src="<?php _ec( get_option("website_logo_color", base_url("assets/img/logo.png")) )?>" class="logo-big h-39">
                <img alt="Logo" src="<?php _ec( get_option("website_logo_mark", base_url("assets/img/logo.png")) )?>" class="logo-small h-39">
